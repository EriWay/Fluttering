...
class RadialAnimation extends StatelessWidget {
        ...
        children: [
          ...
          Transform.scale(
            ...
            child: FloatingActionButton(
              ...
              child: const Icon(FontAwesomeIcons.tree,color: Colors.white,),
            ),
          )
        ]);
    });
  ...
  _buildButton(double angle,  {required Color bgcolor, required Color color, required IconData icon, required BuildContext context, required String route}){
